...
@router.post(
    ...
    description="Saves the trained CTGAN model to a specified file path. This allows for later loading and reuse of the model.",
...
@router.post(
    ...
    description="Loads a previously saved CTGAN model from the specified file path. This allows you to reuse a trained model without retraining.",
    tags=["Model Management"]
)
...
@router.post("/export",
    ...
    description="Exports synthetic data generated by the CTGAN model to a specified format (CSV or JSON). Specify the number of rows and format.",
    tags=["Export"]
)
